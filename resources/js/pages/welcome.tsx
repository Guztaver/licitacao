	...
	const features = [
		{
			...
			description:
				"Cadastro completo com validação de CNPJ, endereços e informações de contato para todos os seus fornecedores.",
		},
		{
			icon: <FileText className="h-8 w-8 text-green-600" />,
			title: "Controle de Requisições",
			description:
				"Gerencie todo o ciclo de vida das requisições de compra desde a criação até a concretização.",
		},
		{
			icon: <CheckCircle className="h-8 w-8 text-purple-600" />,
			title: "Conferências e Auditoria",
			description:
				"Sistema de auditoria robusto para validação de transações e garantia de conformidade.",
		},
		{
			icon: <TrendingUp className="h-8 w-8 text-orange-600" />,
			title: "Relatórios Gerenciais",
			description:
				"Dashboards interativos e relatórios detalhados para análise e tomada de decisão estratégica.",
		},
		{
			icon: <Users className="h-8 w-8 text-indigo-600" />,
			title: "Gestão de Usuários",
			description:
				"Sistema completo de autenticação com diferentes níveis de acesso e permissões granulares.",
		},
		{
			icon: <Shield className="h-8 w-8 text-red-600" />,
			title: "Segurança Avançada",
			description:
				"Logs de auditoria, proteção CSRF, validação rigorosa e conformidade com melhores práticas.",
		},
	];
	...
	return (
		<>
			<Head title="Sistema de Licitações - Modernize seus processos de compra pública">
				...
				<meta
					name="keywords"
					content="licitação, compras públicas, sistema, fornecedores, requisições, auditoria, Brasil"
				/>
			</Head>
					...
					<div className="container mx-auto px-4">
						<div className="mx-auto max-w-4xl text-center">
							...
							<p className="mb-8 text-xl text-slate-600 lg:text-2xl dark:text-slate-300">
								Um sistema completo para gerenciamento de fornecedores,
								requisições de compra e processos de auditoria. Desenvolvido
								especificamente para o contexto brasileiro com foco em
				...
				<section className="py-20">
					<div className="container mx-auto px-4">
						<div className="mx-auto max-w-2xl text-center">
							<h2 className="mb-4 text-3xl font-bold text-slate-900 lg:text-4xl dark:text-slate-100">
								Funcionalidades Completas
							</h2>
							<p className="mb-12 text-lg text-slate-600 dark:text-slate-300">
								Tudo que você precisa para gerenciar processos licitatórios de
				...
				<section className="py-20 bg-slate-50 dark:bg-slate-900">
					<div className="container mx-auto px-4">
						<div className="mx-auto max-w-2xl text-center">
							...
							<p className="mb-12 text-lg text-slate-600 dark:text-slate-300">
								Construído com as melhores tecnologias para garantir
				...
				<section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
					<div className="container mx-auto px-4 text-center">
						<h2 className="mb-4 text-3xl font-bold text-white lg:text-4xl">
							Pronto para modernizar seus processos?
						</h2>
						<p className="mb-8 text-xl text-blue-100">
							Junte-se a organizações que já transformaram seus processos
							licitatórios
						</p>
						<div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
							{auth.user ? (
						...
						<div className="grid gap-8 md:grid-cols-3">
							<div>
								...
								<p className="text-slate-400">
									Modernizando processos de compra pública com tecnologia
									brasileira.
								</p>
							</div>
							<div>
