...
function InputField({ field, value, onChange, error, children }: InputFieldProps) {
...
function FornecedorSelectOptions({ fornecedores }: FornecedorSelectOptionsProps) {
...
export default function ConferenciaCreate({ fornecedores }: CreateProps) {
    const { data, setData, post, processing, errors, reset } = useForm<FormData>(getInitialFormData());
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-6">
                            ...
                            {FORM_FIELDS.map((field) => (
                                ...
                                >
                                    {field.name === 'fornecedor_id' && <FornecedorSelectOptions fornecedores={fornecedores} />}
                                </InputField>
                            ))}
