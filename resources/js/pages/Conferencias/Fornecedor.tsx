...
export default function ConferenciaFornecedor({
    ...
    const { data: pedidoData, setData: setPedidoData, post: postPedido, processing: processingPedido, errors: pedidoErrors, reset: resetPedido } = useForm<PedidoManualForm>({
        descricao: '',
        valor: '',
        numero_pedido: '',
        data_pedido: '',
    ...
    const { data: requisicaoData, setData: setRequisicaoData, patch: patchRequisicao, processing: processingRequisicao, errors: requisicaoErrors } = useForm<RequisicaoEditForm>({
        valor_final: '',
    });
                    ...
                    <div className="space-y-6 lg:col-span-3">
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                {/* Add Pedido Form */}
                                {showAddPedidoForm && (
                                    <form onSubmit={handleAddPedidoManual} className="rounded-lg border p-4 space-y-4">
