...
export default function DestinatariosCreate() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Novo Destinatário" />

            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Novo Destinatário</h1>
                        <p className="text-gray-600 dark:text-gray-400">Cadastre um novo órgão destinatário de requisições</p>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Preencha os dados básicos do órgão emitente</CardDescription>
                        </CardHeader>
                            ...
                            <div className="ml-3">
                                ...
                                <div className="mt-2 text-sm text-blue-700 dark:text-blue-300">
                                    <p>
                                        ...
                                        <br />• Informações de contato são opcionais mas recomendadas
                                    </p>
                                </div>
                            </div>
                        </div>
