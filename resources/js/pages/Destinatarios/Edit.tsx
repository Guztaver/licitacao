...
export default function DestinatariosEdit({
	destinatario,
}: DestinatariosEditProps) {
				...
				<div className="flex items-center justify-between">
					<div>
						...
						<p className="text-gray-600 dark:text-gray-400">
							Atualize as informações do órgão destinatário
						</p>
					</div>
						...
						<div className="flex">
							...
							<div className="ml-3">
								...
								<div className="mt-2 text-sm text-blue-700 dark:text-blue-300">
									<p>
										• Alterações nos dados do destinatário podem afetar
										relatórios existentes
										<br />• A sigla é usada para identificação rápida em listas
										e relatórios
										<br />• Requisições vinculadas a este destinatário não serão
										alteradas
									</p>
								</div>
							</div>
