        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-gray-100">Nova Requisição</h1>
                        <p className="text-gray-600 dark:text-gray-400">Cadastre uma nova requisição no sistema</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Preencha as informações da requisição. Campos marcados com * são obrigatórios.</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                {data.anexo && <p className="text-sm text-green-600">Arquivo selecionado: {data.anexo.name}</p>}
