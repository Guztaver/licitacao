            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">Crie um novo contrato com limites para requisições e conferências</p>
                    </div>
                </div>
                    ...
                    <div className="space-y-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Defina os dados principais do contrato</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select value={data.status} onValueChange={(value: 'ativo' | 'inativo') => setData('status', value)}>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Defina os limites de requisições e conferências. Deixe em branco para ilimitado.</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="grid gap-4 md:grid-cols-2">
                                    <div className="space-y-2">
                        ...
                        <div className="flex justify-end gap-4">
                            ...
                            <Button type="submit" disabled={processing}>
                                ...
                                {processing ? 'Salvando...' : 'Salvar Contrato'}
                            </Button>
                        </div>
                    </div>
                </form>
