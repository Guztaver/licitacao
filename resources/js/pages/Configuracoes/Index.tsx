...
import { Bell, Building, Database, FileText, Mail, Save, Settings, Shield } from 'lucide-react';
...
export default function ConfiguracoesIndex({ configuracoes }: ConfiguracoesIndexProps) {
    const { data, setData, post, processing, errors } = useForm<ConfiguracoesData>({
        // Sistema
        ...
        autenticacao_dois_fatores: configuracoes.autenticacao_dois_fatores ?? false,
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">Gerencie as configurações gerais do sistema</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <CardContent className="space-y-4">
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <div className="space-y-2">
                                    ...
                                    />
                                    {errors.nome_sistema && <p className="text-sm text-red-500">{errors.nome_sistema}</p>}
                                </div>
                                <div className="space-y-2">
                                    ...
                                    />
                                    {errors.versao_sistema && <p className="text-sm text-red-500">{errors.versao_sistema}</p>}
                                </div>
                            </div>
                            <div className="space-y-2">
                                ...
                                />
                                {errors.descricao_sistema && <p className="text-sm text-red-500">{errors.descricao_sistema}</p>}
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Dados da organização responsável pelo sistema</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => setData('nome_organizacao', e.target.value)}
                                        placeholder="Prefeitura Municipal de..."
                                        className={errors.nome_organizacao ? 'border-red-500' : ''}
                                    />
                                    {errors.nome_organizacao && <p className="text-sm text-red-500">{errors.nome_organizacao}</p>}
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => setData('cnpj_organizacao', e.target.value)}
                                        placeholder="00.000.000/0000-00"
                                        className={errors.cnpj_organizacao ? 'border-red-500' : ''}
                                    />
                                    {errors.cnpj_organizacao && <p className="text-sm text-red-500">{errors.cnpj_organizacao}</p>}
                                </div>
                            </div>
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    onChange={(e) => setData('endereco_organizacao', e.target.value)}
                                    placeholder="Endereço completo da organização"
                                    className={errors.endereco_organizacao ? 'border-red-500' : ''}
                                />
                                {errors.endereco_organizacao && <p className="text-sm text-red-500">{errors.endereco_organizacao}</p>}
                            </div>
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => setData('telefone_organizacao', e.target.value)}
                                        placeholder="(XX) XXXXX-XXXX"
                                        className={errors.telefone_organizacao ? 'border-red-500' : ''}
                                    />
                                    {errors.telefone_organizacao && <p className="text-sm text-red-500">{errors.telefone_organizacao}</p>}
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => setData('email_organizacao', e.target.value)}
                                        placeholder="contato@organizacao.gov.br"
                                        className={errors.email_organizacao ? 'border-red-500' : ''}
                                    />
                                    {errors.email_organizacao && <p className="text-sm text-red-500">{errors.email_organizacao}</p>}
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Configurações do servidor SMTP para envio de e-mails</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        className={errors.email_from_address ? 'border-red-500' : ''}
                                    />
                                    {errors.email_from_address && <p className="text-sm text-red-500">{errors.email_from_address}</p>}
                                </div>
                                <div className="space-y-2">
                                    ...
                                    />
                                    {errors.email_from_name && <p className="text-sm text-red-500">{errors.email_from_name}</p>}
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                        ...
                        <CardContent className="space-y-4">
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <div className="flex items-center justify-between space-x-2">
                                    <Label htmlFor="notificacoes_email" className="text-sm font-medium">
                                        Notificações por E-mail
                                    </Label>
                                    <Switch
                                        id="notificacoes_email"
                                        checked={data.notificacoes_email}
                                        onCheckedChange={(checked) => setData('notificacoes_email', checked)}
                                    />
                                </div>
                                <div className="flex items-center justify-between space-x-2">
                                    <Label htmlFor="notificacoes_sistema" className="text-sm font-medium">
                                        Notificações no Sistema
                                    </Label>
                                    <Switch
                                        id="notificacoes_sistema"
                                        checked={data.notificacoes_sistema}
                                        onCheckedChange={(checked) => setData('notificacoes_sistema', checked)}
                                    />
                                </div>
                            </div>
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                                <div className="flex items-center justify-between space-x-2">
                                    <Label htmlFor="notificar_aprovacao" className="text-sm font-medium">
                                        Aprovação de Requisições
                                    </Label>
                                    <Switch
                                        id="notificar_aprovacao"
                                        checked={data.notificar_aprovacao}
                                        onCheckedChange={(checked) => setData('notificar_aprovacao', checked)}
                                    />
                                </div>
                                <div className="flex items-center justify-between space-x-2">
                                    <Label htmlFor="notificar_rejeicao" className="text-sm font-medium">
                                        Rejeição de Requisições
                                    </Label>
                                    <Switch
                                        id="notificar_rejeicao"
                                        checked={data.notificar_rejeicao}
                                        onCheckedChange={(checked) => setData('notificar_rejeicao', checked)}
                                    />
                                </div>
                                <div className="flex items-center justify-between space-x-2">
                                    <Label htmlFor="notificar_vencimento" className="text-sm font-medium">
                                        Vencimento de Prazos
                                    </Label>
                                    <Switch
                                        id="notificar_vencimento"
                                        checked={data.notificar_vencimento}
                                        onCheckedChange={(checked) => setData('notificar_vencimento', checked)}
                                    />
                                </div>
                            </div>
                        </CardContent>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            <div className="flex items-center justify-between space-x-2">
                                <Label htmlFor="backup_automatico" className="text-sm font-medium">
                                    Backup Automático
                                </Label>
                                <Switch
                                    id="backup_automatico"
                                    checked={data.backup_automatico}
                                    onCheckedChange={(checked) => setData('backup_automatico', checked)}
                                />
                            </div>
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <div className="space-y-2">
                                    <Label htmlFor="backup_frequencia">Frequência</Label>
                                    <Select value={data.backup_frequencia} onValueChange={(value) => setData('backup_frequencia', value)}>
                                        <SelectTrigger>
                                            <SelectValue />
                                        </SelectTrigger>
                                        <SelectContent>
                                ...
                                <div className="space-y-2">
                                    ...
                                    />
                                    {errors.backup_retencao && <p className="text-sm text-red-500">{errors.backup_retencao}</p>}
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                        ...
                        <CardContent className="space-y-4">
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <div className="space-y-2">
                                    ...
                                    />
                                    {errors.sessao_timeout && <p className="text-sm text-red-500">{errors.sessao_timeout}</p>}
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => setData('login_tentativas', e.target.value)}
                                        placeholder="5"
                                        min="3"
                                        max="10"
                                        className={errors.login_tentativas ? 'border-red-500' : ''}
                                    />
                                    {errors.login_tentativas && <p className="text-sm text-red-500">{errors.login_tentativas}</p>}
                                </div>
                            </div>
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <div className="flex items-center justify-between space-x-2">
                                    <Label htmlFor="senha_complexidade" className="text-sm font-medium">
                                        Exigir Senha Complexa
                                    </Label>
                                    <Switch
                                        id="senha_complexidade"
                                        checked={data.senha_complexidade}
                                        onCheckedChange={(checked) => setData('senha_complexidade', checked)}
                                    />
                                </div>
                                <div className="flex items-center justify-between space-x-2">
                                    <Label htmlFor="autenticacao_dois_fatores" className="text-sm font-medium">
                                        Autenticação de Dois Fatores
                                    </Label>
                                    <Switch
                                        id="autenticacao_dois_fatores"
                                        checked={data.autenticacao_dois_fatores}
                                        onCheckedChange={(checked) => setData('autenticacao_dois_fatores', checked)}
                                    />
                                </div>
                            </div>
                        </CardContent>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Configurações para geração de relatórios</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <div className="space-y-2">
                                ...
                                />
                                {errors.relatorio_logo && <p className="text-sm text-red-500">{errors.relatorio_logo}</p>}
                            </div>
                            <div className="space-y-2">
                                ...
                                />
                                {errors.relatorio_rodape && <p className="text-sm text-red-500">{errors.relatorio_rodape}</p>}
                            </div>
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <div className="space-y-2">
                                    <Label htmlFor="formato_data_padrao">Formato de Data</Label>
                                    <Select value={data.formato_data_padrao} onValueChange={(value) => setData('formato_data_padrao', value)}>
                                        <SelectTrigger>
                                            <SelectValue />
                                        </SelectTrigger>
                                        <SelectContent>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select value={data.moeda_padrao} onValueChange={(value) => setData('moeda_padrao', value)}>
                                        <SelectTrigger>
                                            <SelectValue />
                                        </SelectTrigger>
                                        <SelectContent>
