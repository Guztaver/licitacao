...
// Components
const InputField = ({ id, label, value, onChange, placeholder, required = false, type = 'text', maxLength, error }: InputFieldProps) => (
...
const ActionButtons = ({ onReset, processing }: { onReset: () => void; processing: boolean }) => (
    <div className="flex items-center justify-end space-x-4">
        <Button type="button" variant="outline" onClick={onReset} disabled={processing} className="min-w-[100px]">
            Limpar
        </Button>
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Novo Fornecedor</h1>
                        <p className="text-gray-600 dark:text-gray-400">Cadastre um novo fornecedor no sistema</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Preencha as informações do fornecedor. Campos marcados com * são obrigatórios.</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-6">
                            ...
                            <div className="space-y-4">
                                <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">Informações de Contato</h3>
