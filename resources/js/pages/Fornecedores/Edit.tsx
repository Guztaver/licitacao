				...
				<form onSubmit={handleSubmit} className="space-y-6">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Atualize os dados básicos do fornecedor
							</CardDescription>
						</CardHeader>
						<CardContent className="space-y-4">
							<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
								...
								<div className="space-y-2">
									...
									/>
									{errors.cnpj_cpf && (
										<p className="text-sm text-red-500">{errors.cnpj_cpf}</p>
									)}
								</div>
							</div>
						...
						<div className="flex">
							...
							<div className="ml-3">
								...
								<div className="mt-2 text-sm text-blue-700 dark:text-blue-300">
									<p>
										• Alterações nos dados do fornecedor podem afetar relatórios
										existentes
										<br />• CNPJ/CPF é formatado automaticamente durante a
										digitação
										<br />• Requisições vinculadas a este fornecedor não serão
										alteradas
									</p>
								</div>
							</div>
