...
interface FornecedorRelatorio extends Pick<Fornecedor, 'id' | 'razao_social' | 'cnpj_formatado' | 'telefone_formatado' | 'email' | 'status' | 'status_display' | 'created_at'> {
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                ...
                <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-6">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-purple-600">{stats.total_requisicoes}</div>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-emerald-600">{formatCurrency(stats.valor_total_geral)}</div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            {stats.total_fornecedores} fornecedores encontrados (ordenados por valor total)
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                                    ...
                                    {fornecedores.length > 0 ? (
                                        fornecedores.map((fornecedor) => (
                                            <TableRow key={fornecedor.id}>
                                                ...
                                                <TableCell>
                                                    {getStatusBadge(fornecedor.status, fornecedor.status_display)}
                                                </TableCell>
                                        ...
                                        <TableRow>
                                            <TableCell colSpan={7} className="py-8 text-center">
                                                ...
                                                <p className="mt-2 text-gray-500">Nenhum fornecedor encontrado com os filtros aplicados</p>
                                            </TableCell>
                                        </TableRow>
                                    )}
                                </TableBody>
                                ...
                                <div className="space-y-3">
                                    {fornecedores
                                        ...
                                        .map((fornecedor, index) => (
                                            <div key={fornecedor.id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                                <div className="flex items-center space-x-3">
                                                    ...
                                                    <div>
                                                        <div className="font-medium text-sm">{fornecedor.razao_social}</div>
                                                        <div className="text-xs text-gray-500">{fornecedor.total_requisicoes} requisições</div>
                                                    </div>
                                                </div>
                                                <div className="text-right">
                                                    <div className="font-medium text-green-600">{formatCurrency(fornecedor.valor_total)}</div>
                                                </div>
                                            </div>
                                        ))}
                                </div>
                                        ...
                                        .map((fornecedor, index) => (
                                            <div key={fornecedor.id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                                <div className="flex items-center space-x-3">
                                                    ...
                                                    <div>
                                                        <div className="font-medium text-sm">{fornecedor.razao_social}</div>
                                                        <div className="text-xs text-gray-500">{formatCurrency(fornecedor.valor_total)}</div>
                                                    </div>
                                                </div>
                                                <div className="text-right">
                                                    <div className="font-medium text-purple-600">{fornecedor.total_requisicoes} req.</div>
                                                </div>
                                            </div>
                                        ))}
                                </div>
