            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-400">Análise detalhada das conferências realizadas</p>
                        </div>
                    </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>{stats.total_conferencias} conferências encontradas (ordenadas por data)</CardDescription>
                    </CardHeader>
                    <CardContent>
                                        ...
                                        conferencias.map((conferencia) => (
                                            <TableRow key={conferencia.id}>
                                                ...
                                                <TableCell className="text-right">
                                                    <span className="font-medium text-blue-600">{formatCurrency(conferencia.total_requisicoes)}</span>
                                                </TableCell>
                                                <TableCell className="text-right">
                                                ...
                                                <TableCell className="text-right">
                                                    <span className="font-medium text-green-600">{formatCurrency(conferencia.total_geral)}</span>
                                                </TableCell>
                                                <TableCell>
                                ...
                                <div className="space-y-3">
                                    {Object.entries(stats.conferencias_por_mes)
                                        ...
                                        .map(([mes, data]) => {
                                            ...
                                            const mesNome = new Date(parseInt(ano, 10), parseInt(mesNum, 10) - 1).toLocaleDateString('pt-BR', {
                                                month: 'long',
                                                year: 'numeric',
                                            });
                                            ...
                                            return (
                                                ...
                                                >
                                                    <div>
                                                        <div className="text-sm font-medium capitalize">{mesNome}</div>
                                                        <div className="text-xs text-gray-500">{data.count} conferências</div>
                                                    </div>
                                                    <div className="text-right">
