...
export default function ForgotPassword({ status }: ForgotPasswordProps) {
	...
	return (
		<AuthLayout
			title={AUTH_MESSAGES.FORGOT_PASSWORD_TITLE}
			description={AUTH_MESSAGES.FORGOT_PASSWORD_DESCRIPTION}
		>
						...
						<>
							...
							<div className="my-6 flex items-center justify-start">
								<AuthSubmitButton processing={processing}>
									{AUTH_MESSAGES.SEND_RESET_LINK_BUTTON}
								</AuthSubmitButton>
							</div>
						</>
					)}
