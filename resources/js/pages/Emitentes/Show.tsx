        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">{emitente.nome}</h1>
                        <p className="text-gray-600 dark:text-gray-400">Detalhes do órgão emitente</p>
                    </div>
                            ...
                            <CardContent className="space-y-6">
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm text-gray-900 dark:text-gray-100">{emitente.nome}</p>
                                    </div>
                                    <div>
                                        <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">Sigla</h3>
                                        <p className="mt-1 font-mono text-sm text-gray-900 dark:text-gray-100">{emitente.sigla}</p>
                                    </div>
                                </div>
                                ...
                                {emitente.endereco && (
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm text-gray-900 dark:text-gray-100">{emitente.endereco}</p>
                                    </div>
                                )}
                                ...
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                    {emitente.telefone && (
                                        <div>
                                            ...
                                            <p className="mt-1 text-sm text-gray-900 dark:text-gray-100">{emitente.telefone}</p>
                                        </div>
                                    )}
                                    {emitente.email && (
                                        <div>
                                            ...
                                            <p className="mt-1 text-sm text-gray-900 dark:text-gray-100">{emitente.email}</p>
                                        </div>
                                    )}
                                </div>
                            ...
                            <CardContent>
                                {emitente.requisicoes && emitente.requisicoes.length > 0 ? (
                                    ...
                                    <div className="py-8 text-center">
                                        ...
                                        <p className="mt-1 text-sm text-gray-500">Este emitente ainda não possui requisições registradas.</p>
                                    </div>
                                )}
                            </CardContent>
                        </Card>
