...
import {
	EmitenteFiltersCard,
	EmitenteHeaderActions,
	EmitentePageHeader,
} from "@/components/emitentes/filter-components";
import {
	EmitenteListCard,
	EmitenteTable,
} from "@/components/emitentes/table-components";
import {
	EmitenteFilterSummary,
	EmitentePagination,
	EmitenteStatsGrid,
} from "@/components/emitentes/ui-components";
import { EMITENTE_LABELS, EMITENTE_MESSAGES } from "@/constants/emitentes";
import {
	useEmitenteActions,
	useEmitenteBreadcrumbs,
	useEmitenteFilters,
	useEmitentePagination,
	useEmitenteStats,
} from "@/hooks/emitentes";
		...
		<AppLayout breadcrumbs={breadcrumbs}>
			...
			<div className="flex h-full flex-1 flex-col gap-6 p-6">
				...
				<EmitentePageHeader
					...
					actions={
						<EmitenteHeaderActions
							onExport={() => handleExport(filters as Record<string, string>)}
