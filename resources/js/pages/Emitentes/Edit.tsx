        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Editar Emitente</h1>
                        <p className="text-gray-600 dark:text-gray-400">Atualize as informações do órgão emitente</p>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Atualize os dados básicos do órgão emitente</CardDescription>
                        </CardHeader>
                            ...
                            <div className="ml-3">
                                ...
                                <div className="mt-2 text-sm text-blue-700 dark:text-blue-300">
                                    <p>
                                        ...
                                        <br />• Requisições vinculadas a este emitente não serão alteradas
                                    </p>
                                </div>
                            </div>
                        </div>
