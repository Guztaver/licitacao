...
export function EmitenteFiltersCard({
	searchValue,
	onSearchChange,
	onSubmit,
	onClear,
	processing = false,
}: EmitenteFiltersCardProps) {
	return (
		<Card>
			<CardHeader>
				<CardTitle className="text-lg">{EMITENTE_LABELS.filters}</CardTitle>
				<CardDescription>
					{EMITENTE_MESSAGES.filtersDescription}
				</CardDescription>
			</CardHeader>
			<CardContent>
				<EmitenteSearchInput
...
export function EmitenteHeaderActions({
	onExport,
	onSuccess,
}: EmitenteHeaderActionsProps) {
	return (
...
export function EmitentePageHeader({
	title,
	description,
	actions,
	backButton,
}: EmitentePageHeaderProps) {
	return (
				...
				{backButton && (
					<Link href={backButton.href}>
						<Button variant="outline">
							{backButton.label || EMITENTE_LABELS.back}
						</Button>
					</Link>
				)}
				{actions}
	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Use múltiplos filtros para refinar sua busca
				</CardDescription>
			</CardHeader>
			<CardContent>
...
export function EmitenteBulkActions({
	...
	return (
		<div className="bg-blue-50 dark:bg-blue-950/20 px-4 py-3 rounded-md">
			<div className="flex items-center justify-between">
