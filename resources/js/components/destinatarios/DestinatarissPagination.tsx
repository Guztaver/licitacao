...
export default function DestinatarissPagination({ links, meta, isFiltered, totalFiltered, onPageClick, onReset }: DestinatarissPaginationProps) {
            ...
            {isFiltered && hasResults && onReset && (
                <div className="border-t px-4 py-3">
                    <div className="flex items-center justify-between text-sm text-gray-600">
                        <div>
                            {DESTINATARIOS_MESSAGES.filtrosAtivos} <span className="font-medium">filtros aplicados</span>
                        </div>
            ...
            {showPagination && (
                <div className="flex items-center justify-between px-2 py-4">
                    <div className="text-sm text-gray-700">
                        {DESTINATARIOS_MESSAGES.mostrando} {meta.from || 0} {DESTINATARIOS_MESSAGES.ate} {meta.to || 0} {DESTINATARIOS_MESSAGES.de}{' '}
                        {isFiltered && totalFiltered !== undefined ? totalFiltered : meta.total || 0} {DESTINATARIOS_MESSAGES.resultados}
                    </div>
