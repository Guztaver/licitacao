...
export default function DestinatarisTable({
	destinatarios: destinatariosList,
	isFiltered,
	onReset,
	onReload,
}: DestinatarisTableProps) {
									...
									{isFiltered ? (
										<>
											<p className="text-gray-500">
												{DESTINATARIOS_LABELS.nenhumResultado}
											</p>
										...
										<>
											<p className="text-gray-500">
												{DESTINATARIOS_LABELS.nenhumDestinatario}
											</p>
						...
						<TableRow key={destinatario.id}>
							<TableCell>
								<div>
									...
									<p className="text-sm text-gray-500">
										Sigla:{" "}
										<span className="font-mono">{destinatario.sigla}</span>
									</p>
							...
							<TableCell>
								<div className="text-sm">
									...
									{destinatario.email && (
										<p className="text-gray-500">{destinatario.email}</p>
									)}
