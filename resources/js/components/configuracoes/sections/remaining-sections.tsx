...
export function BackupSection({ data, setData, errors }: SectionProps) {
	...
	return (
		<ConfigSection
			title={CONFIGURACOES_MESSAGES.BACKUP_TITLE}
			description={CONFIGURACOES_MESSAGES.BACKUP_DESCRIPTION}
			icon={Database}
		>
			<ConfigField
...
export function SegurancaSection({ data, setData, errors }: SectionProps) {
	...
	const handlers = useMemo(
		() => ({
			...
			autenticacao_dois_fatores: createFieldHandler(
				setData,
	...
	return (
		<ConfigSection
			title={CONFIGURACOES_MESSAGES.SEGURANCA_TITLE}
			description={CONFIGURACOES_MESSAGES.SEGURANCA_DESCRIPTION}
			icon={Shield}
		>
			<ConfigGrid columns={2}>
				<ConfigField
...
export function RelatoriosSection({ data, setData, errors }: SectionProps) {
	...
	return (
		<ConfigSection
			title={CONFIGURACOES_MESSAGES.RELATORIOS_TITLE}
			description={CONFIGURACOES_MESSAGES.RELATORIOS_DESCRIPTION}
			icon={FileText}
		>
			<ConfigField
