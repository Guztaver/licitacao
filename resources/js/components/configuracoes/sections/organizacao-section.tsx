...
export default function OrganizacaoSection({ data, setData, errors }: OrganizacaoSectionProps) {
    ...
    return (
        <ConfigSection title={CONFIGURACOES_MESSAGES.ORGANIZACAO_TITLE} description={CONFIGURACOES_MESSAGES.ORGANIZACAO_DESCRIPTION} icon={Building}>
