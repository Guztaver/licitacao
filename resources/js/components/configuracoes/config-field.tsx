...
export default function ConfigField({ config, value, onChange, error, className }: ConfigFieldProps) {
    const fieldId = useId();
    ...
    const renderField = () => {
        switch (config.type) {
            ...
            case 'switch':
                return <Switch id={fieldId} checked={Boolean(value)} onCheckedChange={onChange} />;
