...
export default function CreateFornecedorModal({ trigger, onSuccess }: CreateFornecedorModalProps) {
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div className="space-y-2">
                            ...
                            />
                            {errors.tipo_principal && <p className="text-sm text-red-500">{errors.tipo_principal}</p>}
                        </div>
                    </div>
