...
export default function CreateEmitenteModal({ trigger, onSuccess }: CreateEmitenteModalProps) {
        ...
        <Dialog open={open} onOpenChange={handleOpenChange}>
            ...
            <DialogContent className="max-h-[90vh] max-w-2xl overflow-y-auto">
                <DialogHeader>
                    ...
                    <DialogDescription>Cadastre um novo órgão emitente de requisições</DialogDescription>
                </DialogHeader>
