...
* @see app/Http/Controllers/ItemController.php:184
* @route '/items-import'
*/
...
* @see app/Http/Controllers/ItemController.php:288
* @route '/items-export'
*/
...
const ItemController = { index, create, store, show, edit, update, destroy, importMethod, exportMethod, downloadTemplate, import: importMethod, export: exportMethod }
