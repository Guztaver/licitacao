...
show.url = (
    ...
    const parsedArgs = {
        fornecedor: typeof args.fornecedor === 'object' ? args.fornecedor.id : args.fornecedor,
    };

    return show.definition.url.replace('{fornecedor}', parsedArgs.fornecedor.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
edit.url = (
    ...
    return edit.definition.url.replace('{fornecedor}', parsedArgs.fornecedor.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
update.url = (
    ...
    return update.definition.url.replace('{fornecedor}', parsedArgs.fornecedor.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
destroy.url = (
    ...
    return destroy.definition.url.replace('{fornecedor}', parsedArgs.fornecedor.toString()).replace(/\/+$/, '') + queryParams(options);
};
