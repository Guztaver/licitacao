 ...
 */
export const show = (
    args: { emitente: number | { id: number } } | [emitente: number | { id: number }] | number | { id: number },
...
show.url = (
    ...
    const parsedArgs = {
        emitente: typeof args.emitente === 'object' ? args.emitente.id : args.emitente,
    };

    return show.definition.url.replace('{emitente}', parsedArgs.emitente.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
edit.url = (
    ...
    return edit.definition.url.replace('{emitente}', parsedArgs.emitente.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
update.url = (
    ...
    return update.definition.url.replace('{emitente}', parsedArgs.emitente.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
destroy.url = (
    ...
    return destroy.definition.url.replace('{emitente}', parsedArgs.emitente.toString()).replace(/\/+$/, '') + queryParams(options);
};
