    ...
    public function run(): void
    {
        ...
        $contratos = [
            [
                ...
                'descricao' => 'Contrato anual para fornecimento de materiais de escritório com limites definidos.',
                'status' => 'ativo',
            ...
            [
                ...
                'descricao' => 'Contrato semestral para serviços de manutenção.',
                'status' => 'ativo',
                'usuario_criacao_id' => $user->id ?? null,
            ],
            [
                ...
                'descricao' => 'Contrato trimestral sem limites de requisições e conferências.',
                'status' => 'ativo',
                'usuario_criacao_id' => $user->id ?? null,
            ],
            [
                ...
                'descricao' => 'Contrato geral para múltiplos fornecedores com limites amplos.',
                'status' => 'ativo',
                'usuario_criacao_id' => $user->id ?? null,
            ],
            [
